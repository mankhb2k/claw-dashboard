# Build claw-dashboard-desktop.zip for GitHub Releases
...
$ZipName = "claw-dashboard-desktop-$Version.zip"
$StagingName = "claw-dashboard-desktop"
...
$Include = @(
  "docker-compose.yml",
  ".env.example",
  "Setup-Claw-Dashboard.bat",
  "Stop-Claw-Dashboard.bat",
  "HUONG-DAN.md",
...
Write-Host "  gh release create desktop-v$Version `"$ZipPath`" --title `"Claw Dashboard Desktop $Version`""
