...
echo.
echo  ========================================
echo   Claw Dashboard - Cai dat va khoi dong
echo  ========================================
echo.
...
if defined PORT_CONFLICT (
  ...
  echo    2. Hoac chay Stop-Claw-Dashboard.bat neu stack cu con treo
  echo.
...
echo.
echo [2/3] Dang khoi dong Claw Dashboard...
docker compose up -d
if errorlevel 1 (
  echo [LOI] Khoi dong that bai. Xem log trong Docker Desktop ^> Containers ^> claw-dashboard
  pause
  exit /b 1
)
...
echo.
echo   Quan ly trong Docker Desktop ^> Containers ^> claw-dashboard
echo   Dung Claw Dashboard: chay Stop-Claw-Dashboard.bat
echo  ========================================
echo.
