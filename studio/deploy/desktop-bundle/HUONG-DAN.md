...
1. Tải file **`claw-dashboard-desktop.zip`** từ [GitHub Releases](https://github.com/openclaw/studio/releases)
...
```powershell
cd studio\deploy\desktop-bundle
.\build-zip.ps1
# Hoặc chỉ định version:
.\build-zip.ps1 -Version "1.0.0"
```

File ra: `studio\deploy\dist\claw-dashboard-desktop-1.0.0.zip`
...
```text
https://github.com/openclaw/studio/releases/download/desktop-v1.0.0/claw-dashboard-desktop-1.0.0.zip
```
...
- Image pull từ Docker Hub: `studio/api`, `studio/web`, `alpine/openclaw`, `postgres:16-alpine`
