...
const OSS_RUNTIME_ACTION_MSG =
  'OSS runtime uses a shared gateway container. Start or restart it with Docker (e.g. openclaw-fork on port 18789), not per-project spawn.';
...
export class ProjectsService {
  ...
  private async syncOssProjectFromGateway(
    ...
    const gatewayDownMsg =
      'Gateway is not reachable on port 18789. Run Openclaw and match OPENCLAW_GATEWAY_TOKEN in studio/apps/.env.';
