import type { GeminiModelDef, GeminiProviderModelEntry } from './gemini-models.types.js';
...
export function toGeminiProviderModelEntries(
  models: GeminiModelDef[] = GEMINI_CHAT_MODELS,
): GeminiProviderModelEntry[] {
  return models.map((m) => ({
    id: m.id,
    name: m.name,
