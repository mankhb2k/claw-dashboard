...
export const SKILL_EDITOR_UI_LS_KEY = 'skill-editor-ui';

interface SkillEditorUiState {
...
export const useSkillEditorUiStore = create<SkillEditorUiState>()(
  persist(
    (set) => ({
      skillPanelOpen: true,
