import{c as e,i as t}from"./preload-helper-D2yxXLVK.js";import{P as n,d as r}from"./iframe-DNP4h_7x.js";import{t as i}from"./Button-BQKtsxgJ.js";import{n as a,r as o,t as s}from"./ui-DFk-01dI.js";import{t as c}from"./Typography-COzlN_kt.js";import{n as l}from"./Box-C4Um3A3-.js";import{n as u}from"./Container-YBu3lMrr.js";import{n as d,t as f}from"./Flex-CFK6x4RX.js";import{n as p}from"./Grid-B3WDYbwo.js";var m=t((()=>{l(),d(),p(),u()})),h,g,_,v,y,b,x,S,C;t((()=>{h=r(),g=e(n()),o(),m(),s(),_={title:`UI/Spinner`,component:a,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`sm`,`md`,`lg`],description:`Kích thước của spinner`},loading:{control:`boolean`,description:`Trạng thái hiển thị`}}},v={args:{size:`md`,loading:!0}},y={render:()=>(0,h.jsxs)(f,{align:`center`,gap:4,children:[(0,h.jsxs)(f,{direction:`column`,align:`center`,gap:1,children:[(0,h.jsx)(a,{size:`sm`}),(0,h.jsx)(c,{variant:`small`,children:`Small`})]}),(0,h.jsxs)(f,{direction:`column`,align:`center`,gap:1,children:[(0,h.jsx)(a,{size:`md`}),(0,h.jsx)(c,{variant:`small`,children:`Medium`})]}),(0,h.jsxs)(f,{direction:`column`,align:`center`,gap:1,children:[(0,h.jsx)(a,{size:`lg`}),(0,h.jsx)(c,{variant:`small`,children:`Large`})]})]})},b={render:()=>(0,h.jsx)(()=>{let[e,t]=g.useState(!0);return(0,h.jsxs)(f,{direction:`column`,gap:2,align:`start`,children:[(0,h.jsxs)(`button`,{onClick:()=>t(!e),style:{padding:`var(--space-2) var(--space-3)`,background:`var(--color-bg-subtle)`,border:`1px solid var(--color-border)`,borderRadius:`var(--radius-md)`,cursor:`pointer`},children:[`Toggle Loading: `,e?`ON`:`OFF`]}),(0,h.jsxs)(f,{align:`center`,gap:2,children:[(0,h.jsx)(a,{loading:e}),(0,h.jsx)(c,{variant:`p`,children:e?`Đang tải dữ liệu...`:`Dữ liệu đã tải xong!`})]})]})},{})},x={render:()=>(0,h.jsx)(()=>{let[e,t]=g.useState(!1);return(0,h.jsxs)(i,{onClick:()=>{t(!0),setTimeout(()=>t(!1),2e3)},disabled:e,style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[e&&(0,h.jsx)(a,{size:`sm`}),e?`Đang xử lý...`:`Bấm vào đây`]})},{})},S={render:()=>(0,h.jsx)(()=>{let[e,t]=g.useState(!1),[n,r]=g.useState(!1);return(0,h.jsxs)(f,{align:`center`,gap:2,children:[(0,h.jsx)(`button`,{onClick:()=>{t(!0),setTimeout(()=>{t(!1),r(!n)},1500)},disabled:e,style:{background:`transparent`,border:`none`,cursor:`pointer`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`var(--space-2)`,borderRadius:`50%`,color:n?`var(--color-primary)`:`var(--color-text-muted)`,transition:`background var(--transition-fast) ease`},children:e?(0,h.jsx)(a,{size:`sm`}):n?(0,h.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,h.jsx)(`path`,{d:`M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16l-7-3.5zm2-2.55l5-2.5 5 2.5V5H7z`})}):(0,h.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`18`,height:`18`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:(0,h.jsx)(`path`,{d:`M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z`})})}),(0,h.jsx)(c,{variant:`small`,color:`muted`,children:e?`Đang lưu...`:n?`Đã lưu vào Bookmark`:`Lưu vào Bookmark`})]})},{})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    size: "md",
    loading: true
  }
      ...
      return <Flex direction="column" gap={2} align="start">\r
          ...
          <Flex align="center" gap={2}>\r
            ...
            <Typography variant="p">\r
              {loading ? "Đang tải dữ liệu..." : "Dữ liệu đã tải xong!"}\r
            </Typography>\r
          </Flex>\r
        </Flex>;
    };
    ...
    const ButtonDemo = () => {
      ...
      return <Button onClick={handleClick} disabled={loading} style={{
        ...
        gap: "8px"
          ...
          {loading ? "Đang xử lý..." : "Bấm vào đây"}\r
        </Button>;
    };
    return <ButtonDemo />;
  }
    ...
    const BookmarkDemo = () => {
      ...
      return <Flex align="center" gap={2}>\r
          ...
          <Typography variant="small" color="muted">\r
            {loading ? "Đang lưu..." : isBookmarked ? "Đã lưu vào Bookmark" : "Lưu vào Bookmark"}\r
          </Typography>\r
        </Flex>;
    };
    return <BookmarkDemo />;
