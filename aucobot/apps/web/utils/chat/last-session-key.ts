const LAST_KEY_PREFIX = 'aucobot.chat.lastSessionKey'
const LAST_AGENT_PREFIX = 'aucobot.chat.lastAgentId'
const SIDEBAR_COLLAPSED_PREFIX = 'aucobot.chat.sidebarCollapsed'
