...
export const APIKEY_PROVIDERS: ProviderData[] = [
  ...
  },
  {
    ...
    catalogSource: {
      ...
      label: 'xAI API',
      note: 'Grok chat models via OpenClaw provider `xai`.',
    },
    apiKeyUrl: 'https://console.x.ai/team/default/api-keys',
    apiKeyLabel: 'Get xAI API key',
  },
  {
    id: 'mistral',
    name: 'Mistral',
...
const AI_PROVIDER_UI: Record<string, ProviderUiMetadata> = {
  openrouter: {
    icon: 'hub',
    color: '#6366F1',
    iconSrc: '/models-icon/OpenRouter-icon.svg',
  ...
  together: {
    icon: 'groups',
    color: '#0EA5E9',
    iconSrc: '/models-icon/Together-icon.svg',
  ...
  'vercel-ai-gateway': {
    icon: 'cloud',
    color: '#000000',
    iconSrc: '/models-icon/Vercel-icon.svg',
  ...
  kilocode: {
    icon: 'bolt',
    color: '#8B5CF6',
    iconSrc: '/models-icon/Kilo-icon.svg',
