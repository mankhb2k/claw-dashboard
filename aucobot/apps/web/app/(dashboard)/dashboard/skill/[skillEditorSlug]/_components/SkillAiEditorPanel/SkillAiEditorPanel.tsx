...
import type {
  SkillAiEditorMessage,
  SkillAiEditorOptionsResponse,
} from "@/schemas/project.schema";
import type { ProjectSkillDetail } from "@/schemas/project.schema";
import styles from "./SkillAiEditorPanel.module.css";

type ChatRow = SkillAiEditorMessage & { id: string };

interface SkillAiEditorPanelProps {
  projectId: string;
...
export function SkillAiEditorPanel({
  projectId,
  skill,
  currentBodyMarkdown,
  onApplyMarkdown,
}: SkillAiEditorPanelProps) {
  const [options, setOptions] = useState<SkillAiEditorOptionsResponse | null>(null);
