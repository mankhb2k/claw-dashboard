...
export type AgentPanelComposerProps = {
  value: string;
...
export function AgentPanelComposer({
  ...
  sending,
  disabled = false,
  placeholder = "Mô tả agent, hỏi về tab, hoặc nhờ viết AGENTS.md…",
  providerId,
  providerOptions,
  onProviderChange,
  modelId,
        ...
        <div className={messageBoxStyles.toolbar}>
          <div className={messageBoxStyles.toolbarLeft}>
            <div className={messageBoxStyles.toolbarSelect}>
              <Select
                id="agent-panel-composer-provider"
                labelPosition="none"
