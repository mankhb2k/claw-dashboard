...
import type { OverviewChartDataPoint } from './OverviewChart/OverviewChart'
import type { UsageTableRow } from './UsageTable/UsageTable'
...
const MODEL_COLORS = ['#10b981', '#3b82f6', '#f59e0b', '#ec4899', '#8b5cf6']
