export const viConnect = {
  ...
  detail: {
    ...
    ask: 'Hỏi',
    block: 'Chặn',
    loadFailed: 'Không tải được connectors',
    ...
    notFoundProject: 'Project không tồn tại hoặc bạn không có quyền truy cập.',
    notFoundConnector: 'Connector không khả dụng hoặc không được backend hỗ trợ.',
    backToConnections: 'Về danh sách kết nối',
  },
  groups: {
