import {
  smokeTestGeminiApiKey,
  type GeminiApiKeySmokeResult,
} from './gemini/gemini-test-key';
import {
  smokeTestOpenAiApiKey,
  type OpenAiApiKeySmokeResult,
} from './openai/openai-test-key';
