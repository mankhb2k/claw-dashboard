/**
 * ESLint flat config — @aucobot/api
 *
...
const MSG = {
  ...
  libDatabaseEnum:
    'Prefer @aucobot/shared for enums in lib/ — runtime @aucobot/database is legacy (rule.md §3.F).',
  coreNoFeatures:
    'core/ must not import feature modules (rule.md §3.D).',
  cloudPackages:
    'Cloud packages belong in ../cloud — aucobot/apps is self-host only (rule.md §1.13).',
};
...
const RULES_IMPORT = {
  ...
  'import/order': [
    'error',
    {
      ...
      pathGroups: [{ pattern: '@aucobot/**', group: 'internal' }],
...

  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-restricted-imports': [
        ...
        {
          patterns: [
            { group: ['@aucobot-cloud/*'], message: MSG.cloudPackages },
          ],
        },
      ],
