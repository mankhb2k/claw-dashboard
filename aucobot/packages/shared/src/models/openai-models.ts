import type { OpenAiModelDef, OpenAiProviderModelEntry } from './openai-models.types.js';
...
export function toOpenAiProviderModelEntries(
  models: OpenAiModelDef[] = OPENAI_CHAT_MODELS,
