...
| Endpoint                    | Mô tả                                |
| --------------------------- | ------------------------------------ |
| `GET /v1/models`            | Danh sách models (OpenAI-compatible) |
| `GET /v1/models/{id}`       | Chi tiết một model                   |
| `POST /v1/chat/completions` | Chat completions (OpenAI-compatible) |
| `POST /v1/responses`        | Agent responses API                  |
| `POST /v1/embeddings`       | Embeddings                           |
| `POST /tools/invoke`        | Gọi tool trực tiếp                   |
| `/__openclaw__/canvas/`     | Canvas host (HTML/CSS/JS)            |
| `/__openclaw__/a2ui/`       | A2UI host                            |
| `/voiceclaw/realtime`       | Voice realtime WebSocket             |
...
| `trusted-proxy` | Reverse proxy header-based (non-loopback)                |
...
| **Runtime**           | Node 24 (recommended), Node 22.14+ (min)                                      |
| **License**           | MIT                                                                           |
