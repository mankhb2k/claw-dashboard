export const enSkills = {
  page: {
    ...
    noProject: "No project. Please create a project before managing skills.",
    noProjectEdit: "No project yet. Create a project before editing a skill.",
  ...
  toasts: {
    ...
    syncFailed: "Skill sync failed",
    enabled: "Enabled skill",
    enabledDescription:
      "Synced to OpenClaw — agent applies at the next chat message (/new if old session).",
    disabled: "Disabled skill",
    disabledDescription: "Removed from OpenClaw workspace.",
    statusChangeFailed: "Cannot change skill status",
    deleted: "Deleted skill successfully",
    deleteFailed: "Delete skill failed",
    installed: "Installed skill",
    installedDescription: "{{name}} is ready to edit.",
    installFailed: "Install failed",
    saveFailed: "Failed to save skill",
    aiUpdated: "AI updated the editor",
    aiUpdatedDescription: "Saving to skill…",
    copied: "Copied SKILL.md",
    copyFailed: "Could not copy to clipboard",
    zipDownloadFailed: "ZIP download failed",
  },
  errors: {
    loadList: 'Could not load skills',
    load: 'Failed to load skill',
    save: 'Failed to save skill',
    loadStore: 'Cannot load skill store.',
    installFromStore: 'Cannot install from Browser Store.',
