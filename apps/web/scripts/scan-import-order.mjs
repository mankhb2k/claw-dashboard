...
const PROFILES = {
  ...
  clawDashboardLight: {
    name: "Claw Dashboard đề xuất — warn, nhóm rõ, không alphabetize",
    rule: [
      "warn",
      {
        groups: [
  ...
  clawDashboardStrict: {
    name: "Claw Dashboard strict — + alphabetize + type last",
    rule: [
      "warn",
      {
        groups: [
...
console.log("Scanning @claw-dashboard/web import/order profiles...\n");
