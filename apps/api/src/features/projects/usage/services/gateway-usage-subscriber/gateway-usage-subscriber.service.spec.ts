...
import { isOssRuntime } from '@claw-dashboard/runtime-contracts';
import { resolveOssGatewayEndpoint } from '@claw-dashboard/runtime-oss';

jest.mock('@claw-dashboard/control-plane-core', () => ({
  openGatewayUpstream: jest.fn(),
}));

jest.mock('@claw-dashboard/runtime-contracts', () => ({
  isOssRuntime: jest.fn(() => true),
}));

jest.mock('@claw-dashboard/runtime-oss', () => ({
