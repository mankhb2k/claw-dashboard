...
-- CreateEnum
CREATE TYPE "HeavyTool" AS ENUM ('FFMPEG', 'PLAYWRIGHT', 'TTS', 'STT');
...
CREATE TABLE "plans" (
    ...
    "heavyJobsPerDay" INTEGER NOT NULL DEFAULT 3,
...
CREATE TABLE "projects" (
    ...
    "heavyQuotaUsed" INTEGER NOT NULL DEFAULT 0,
    "errorMessage" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_planId_fkey" FOREIGN KEY ("planId") REFERENCES "plans"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
