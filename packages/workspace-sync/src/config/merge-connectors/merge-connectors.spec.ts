...
import type { ConnectorMergeRow } from './merge-connectors.js';
...
describe('mergeConnectorsIntoConfig', () => {
  ...
  it('writes Google Drive credential files in stdio mode', async () => {
    ...
    assert.deepEqual(entry.args, ['-y', '@modelcontextprotocol/server-gdrive']);
